...
BEST_MODEL_PATH = OUTPUT_ROOT / "best_cnn_lstm_mps.pth"
HISTORY_CSV_PATH = OUTPUT_ROOT / "cnn_lstm_training_history.csv"
TEST_REPORT_JSON_PATH = OUTPUT_ROOT / "cnn_lstm_test_report.json"
CONFUSION_MATRIX_CSV_PATH = OUTPUT_ROOT / "cnn_lstm_confusion_matrix.csv"
